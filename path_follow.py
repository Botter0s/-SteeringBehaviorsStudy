...
class World(object):
    ...
    def setAI(self):
        ...
        [self.AIbehaviors.addToPath(choice([self.target1.getPos(),self.target2.getPos(),self.target3.getPos(),self.target4.getPos()])) for i in range(10)]
